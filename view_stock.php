					...
					<div>
						<div class="body">
							...
							<tr>
								...
								<td><a href="?delete_all=all" style="color:red;" title="click for delete this product" onclick="return confirm('sure to delete ?')">Delete All</a></td>
								</tr>
								</table>
							<table class="table1">
							<tr>
							...
							<?php
							$stmt = $DB_con->prepare('SELECT * FROM stocks');
							$stmt->execute();	
							if($stmt->rowCount() > 0) {
							...
							?>
								<tr>
									...
									<td>
									<a href="edit_stock.php?<?php echo $edit; ?>" style="color:green;" title="click for delete this product" onclick="return confirm('sure to edit ?')"> Edit</a> 
									<a href="?delete_id=<?php echo $row['pid']; ?>" style="color:red;" title="click for delete this product" onclick="return confirm('sure to delete ?')"> Delete</a>
									</td>
								</tr>
								<?php } } ?>
