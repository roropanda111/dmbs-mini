	...
	<div id="background" >
		<div id="page">
			...
			<div id="contents">		
						...
						<div  style="background:white; height:200px; margin-left:5px;margin-right:5px; ">
						<br>
							<h1 style="margin-left:10px;color:green;">Customer options</h1>
								<ul>
									<li>
										<h4>Order Medicine</h4>
										
										
										Ordering Medicines with proper details such as medicine name,quantity
